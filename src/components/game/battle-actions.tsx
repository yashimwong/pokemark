...
const BattleActions = ({ moves, canCatch, canRun, pokeballs, disabled, onFight, onCatch, onRun, onSwitch }: { moves: Move[]; canCatch: boolean; canRun: boolean; pokeballs: number; disabled?: boolean; onFight: (move: Move) => void; onCatch: () => void; onRun: () => void; onSwitch: () => void }) => (
    <div className="battle-actions">
        ...
        <div className="battle-options">
            ...
            {canCatch && <button type="button" onClick={onCatch} className="battle-option" disabled={disabled || pokeballs === 0}><FiDisc /><span>Poké Ball × {pokeballs}</span></button>}
