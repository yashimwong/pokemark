...
export const wildEncounterIds = ["flitter", "mossbug", "sparko", "pebblit", "mindove"];

export const trainers: Trainer[] = [
    { id: "mia", name: "Mia", title: "Youngster", greeting: "My team has been training in the tall grass!", defeatText: "That was a brilliant battle!", x: 11, y: 4, direction: "left", pokemon: [createPokemon("mossbug", 4), createPokemon("flitter", 5)], reward: 180 },
    { id: "kai", name: "Kai", title: "Ranger", greeting: "The river trail is a real test for new trainers.", defeatText: "Your bond is stronger than I expected.", x: 3, y: 7, direction: "down", pokemon: [createPokemon("pebblit", 6)], reward: 240 },
    { id: "luna", name: "Luna", title: "Ace Trainer", greeting: "Show me what your first partner can do!", defeatText: "You have earned your first badge.", x: 12, y: 7, direction: "right", pokemon: [createPokemon("mindove", 7), createPokemon("sparko", 7)], reward: 500 }
];
